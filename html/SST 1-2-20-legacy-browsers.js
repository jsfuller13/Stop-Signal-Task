...
function b1_instuctionsLoopBegin(thisScheduler) {
  ...
  trialIterator = b1_instuctions[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB1_instuction = result.value;
...
function B2_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = B2_trials[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB2_trial = result.value;
...
function B1_InstrRoutineBegin() {
  ...
  B1_InstrComponents.forEach( function(thisComponent) {
...
function B1_TrialsRoutineBegin() {
  ...
  B1_TrialsComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function B2_InstrRoutineBegin() {
  ...
  B2_InstrComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function B2_TrialsRoutineBegin() {
  ...
  B2_TrialsComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
