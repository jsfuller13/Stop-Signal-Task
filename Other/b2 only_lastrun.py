...
expName = 'b2 only'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Jordan\\Documents\\Experiment Building\\3. Stop Signal Task\\b2 only_lastrun.py',
...
for thisB2_trial in B2_trials:
    ...
    sound_1.setVolume(sig_volume, log=False)
    # keep track of which components have finished
    B2_TrialsComponents = [B2_stim_text, B2_resp, B2_fixation, sound_1]
    ...
    B2_trials.addData('sound_1.started', sound_1.tStartRefresh)
    B2_trials.addData('sound_1.stopped', sound_1.tStopRefresh)
    thisExp.nextEntry()
